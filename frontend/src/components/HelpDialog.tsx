        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          <div className="mb-6">
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              CodeX supports VS Code-style keyboard shortcuts for efficient markdown editing. 
              Use these shortcuts to format text, create headers, lists, and more without lifting your hands from the keyboard.
            </p>
          </div>
          ...
          {/* Additional Tips */}
          <div className="mt-8 p-4 rounded-lg" style={{ backgroundColor: 'var(--color-card)' }}>
            <h3 className="text-lg font-semibold mb-3 flex items-center gap-2">
              <CommandIcon size={20} className="text-green-500" />
              Pro Tips
            </h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li>• <strong>Tab Indentation:</strong> Use Tab to indent lines or code blocks, just like in VS Code</li>
              <li>• <strong>Multi-line Selection:</strong> Select multiple lines and use Tab/Shift+Tab to indent/unindent all at once</li>
              <li>• <strong>Extended Syntax:</strong> Support for task lists, footnotes, definition lists, subscript/superscript, and highlighting</li>
              <li>• <strong>Auto-save:</strong> Enable auto-save in Settings to automatically save your work every 30 seconds</li>
              <li>• <strong>Preview Toggle:</strong> Click the eye icon or use toolbar buttons to toggle between editor and preview modes</li>
              <li>• <strong>Word Wrap:</strong> Toggle word wrap to handle long lines (Alt+Z)</li>
            </ul>
          </div>

          {/* Markdown Quick Reference */}
          <div className="mt-8 p-4 rounded-lg" style={{ backgroundColor: 'var(--color-card)' }}>
            <h3 className="text-lg font-semibold mb-3">Markdown Quick Reference</h3>
